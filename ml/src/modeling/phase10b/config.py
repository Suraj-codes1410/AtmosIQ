"""
AtmosIQ Phase 10B: Configuration System for Production Observability & Governance.
"""
...
class Phase10BConfig:
    ...
    # Canonical Production Model Identity
    ...
    # Calibration & Uncertainty Parameters (Phase 9C-9D Certified)
    ...
    psi_yellow_threshold: float = 0.25
    psi_orange_threshold: float = 0.50

    wasserstein_yellow_threshold: float = 0.20
    wasserstein_orange_threshold: float = 0.40
    wasserstein_red_threshold: float = 0.70

    mae_alert_multiplier: float = 1.25 # 25% degradation triggers YELLOW/ORANGE
    bias_critical_threshold: float = 15.0 # µg/m³ absolute bias

    latency_single_sla_ms: float = 10.0
    latency_batch_sla_ms: float = 50.0
    ...
    phase10_manifests_dir: Path = field(default_factory=lambda: Path("/home/suraj/atmosIQ/ml/experiments/phase10_production/manifests"))

    # Output Directories
    exp_dir: Path = field(default_factory=lambda: Path("/home/suraj/atmosIQ/ml/experiments/phase10b_observability"))
    manifests_dir: Path = field(default_factory=lambda: Path("/home/suraj/atmosIQ/ml/experiments/phase10b_observability/manifests"))
    audits_dir: Path = field(default_factory=lambda: Path("/home/suraj/atmosIQ/ml/experiments/phase10b_observability/audits"))
    benchmarks_dir: Path = field(default_factory=lambda: Path("/home/suraj/atmosIQ/ml/experiments/phase10b_observability/benchmarks"))
    reports_dir: Path = field(default_factory=lambda: Path("/home/suraj/atmosIQ/ml/experiments/phase10b_observability/reports"))
    figures_dir: Path = field(default_factory=lambda: Path("/home/suraj/atmosIQ/ml/experiments/phase10b_observability/figures"))
    hashes_dir: Path = field(default_factory=lambda: Path("/home/suraj/atmosIQ/ml/experiments/phase10b_observability/hashes"))
    ...
    def get_config_hash(self) -> str:
        cfg = {
            ...
            "psi_thresholds": [self.psi_green_threshold, self.psi_yellow_threshold, self.psi_orange_threshold],
        }
