"""
AtmosIQ Phase 9: Configuration System.
"""
...
class Phase9Config:
    ...
    augmentation_ratios: List[float] = field(default_factory=lambda: [0.0, 0.10, 0.25, 0.50])
    ...
    # Output Directories
    exp_dir: Path = field(default_factory=lambda: Path("/home/suraj/atmosIQ/ml/experiments/phase9_deep_learning"))
    manifests_dir: Path = field(default_factory=lambda: Path("/home/suraj/atmosIQ/ml/experiments/phase9_deep_learning/manifests"))
    audits_dir: Path = field(default_factory=lambda: Path("/home/suraj/atmosIQ/ml/experiments/phase9_deep_learning/audits"))
    benchmarks_dir: Path = field(default_factory=lambda: Path("/home/suraj/atmosIQ/ml/experiments/phase9_deep_learning/benchmarks"))
    checkpoints_dir: Path = field(default_factory=lambda: Path("/home/suraj/atmosIQ/ml/experiments/phase9_deep_learning/checkpoints"))
    reports_dir: Path = field(default_factory=lambda: Path("/home/suraj/atmosIQ/ml/experiments/phase9_deep_learning/reports"))
    figures_dir: Path = field(default_factory=lambda: Path("/home/suraj/atmosIQ/ml/experiments/phase9_deep_learning/figures"))
