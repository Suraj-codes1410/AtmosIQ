...
@dataclass
class ConformalConfigPhase6C:
    project: str = "AtmosIQ"
    phase: str = "Phase 6C"
    experiment_name: str = "Conformal Prediction & Calibration"
    ...
    # Epsilon for normalization denominator
    epsilon: float = 1e-4
    random_seed: int = 42
    ...
    @classmethod
    def load_json(cls, json_path: Path) -> "ConformalConfigPhase6C":
