"""
AtmosIQ Phase 10 + Phase 10A: Configuration System.
"""
...
@dataclass
class Phase10Config:
    phase_name: str = "Phase 10 + Phase 10A"
    ...
    # Walk-Forward / Rolling-Origin Fold Definitions (Phase 10A)
    # Window A: 2020-01 to 2020-12 (Train) -> 2021-01 to 2021-06 (Val)
    # Window B: 2020-01 to 2021-06 (Train) -> 2021-07 to 2021-12 (Val)
    # Window C: 2020-01 to 2021-12 (Train) -> 2022-01 to 2022-12 (Val)
    # Window D: 2020-01 to 2022-12 (Train) -> 2023-01 to 2024-12 (Val)
    walkforward_folds: List[Dict[str, str]] = field(default_factory=lambda: [
        {"fold_id": "WF_Window_A", "train_start": "2020-01-01", "train_end": "2020-12-31", "val_start": "2021-01-01", "val_end": "2021-06-30"},
        {"fold_id": "WF_Window_B", "train_start": "2020-01-01", "train_end": "2021-06-30", "val_start": "2021-07-01", "val_end": "2021-12-31"},
        {"fold_id": "WF_Window_C", "train_start": "2020-01-01", "train_end": "2021-12-31", "val_start": "2022-01-01", "val_end": "2022-12-31"},
        {"fold_id": "WF_Window_D", "train_start": "2020-01-01", "train_end": "2022-12-31", "val_start": "2023-01-01", "val_end": "2024-12-31"},
    ])
    ...
    phase9cd_manifests_dir: Path = field(default_factory=lambda: Path("/home/suraj/atmosIQ/ml/experiments/phase9cd_hardening/manifests"))

    # Output Directories
    exp_dir: Path = field(default_factory=lambda: Path("/home/suraj/atmosIQ/ml/experiments/phase10_production"))
    manifests_dir: Path = field(default_factory=lambda: Path("/home/suraj/atmosIQ/ml/experiments/phase10_production/manifests"))
    audits_dir: Path = field(default_factory=lambda: Path("/home/suraj/atmosIQ/ml/experiments/phase10_production/audits"))
    benchmarks_dir: Path = field(default_factory=lambda: Path("/home/suraj/atmosIQ/ml/experiments/phase10_production/benchmarks"))
    reports_dir: Path = field(default_factory=lambda: Path("/home/suraj/atmosIQ/ml/experiments/phase10_production/reports"))
    figures_dir: Path = field(default_factory=lambda: Path("/home/suraj/atmosIQ/ml/experiments/phase10_production/figures"))
    hashes_dir: Path = field(default_factory=lambda: Path("/home/suraj/atmosIQ/ml/experiments/phase10_production/hashes"))

    # Production Candidate Identities
    ...
    fallback_candidate_version: str = "AtmosIQ_DL_LSTM_CAL07_25_PRODUCTION_CANDIDATE_v1.0.0"
    ...
    def get_config_hash(self) -> str:
        cfg = {
            ...
            "seeds": self.seeds,
            "walkforward_folds": self.walkforward_folds,
        }
